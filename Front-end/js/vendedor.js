...
function getAll() {
    $.ajax({
        url: "http://192.168.100.4:8088/sellers/allSellers",
        type: "GET",
...
function getVendedor(valor) {
    $.ajax({
        url: "http://192.168.100.4:8088/sellers/allSellers/" + valor,
        type: "GET",
        contentType: "application/json; charset=utf-8",
        cache: false,
        timeout: 600000,
...
function getSearch(valor) {
    $.ajax({
        url: "http://192.168.100.4:8088/products/getProduct/" + valor,
        type: "GET",
        contentType: "application/json; charset=utf-8",
        cache: false,
        timeout: 600000,
